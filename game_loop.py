    ...
    "characters": [
        {
            ...
            "personality": "Composed, intelligent, manipulative, and obsessed with preserving the Ashworth legacy, lady of house,",
            "environment": "Manor House",
        },
        {
            "name": "Nigel Graves",
            "personality": "Gruff, loyal, easily irritated, but notices details others ignore,banker",
            "environment": "Bank",
        },
        {
            "name": "Beatrice Holloway",
            "personality": "Elegant, gossip-loving, curious, and skilled at uncovering secrets, actor",
            "environment": "Theatre",
        },
        {
            "name": "Oliver Finch",
            "personality": "Nervous, analytical, intelligent, and easily frightened, fisherman",
            "environment": "Dockyard",
        },
        {
            "name": "Martha Doyle",
            "personality": "Kind, practical, hardworking, and protective of ordinary townsfolk, priest",
            "environment": "Church",
        },
        {
            "name": "Clara Whitmore",
...
async def main():
    ...
    while True:
        ...
        if screen_state == ScreenState.MAIN_MENU:
            ...
            console.print("[bold red]Loading Game[/]")
